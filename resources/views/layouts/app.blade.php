...
<html lang="en">
   <head>
      ...
      <title>@yield('page-title') | School System</title>
      <!-- Bootstrap -->
                  ...
                  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                     <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                           ...
                           <li>
                              <a><i class="fa fa-home"></i> Teachers <span class="fa fa-chevron-down"></span></a>
                              <ul class="nav child_menu">
                                 <li><a href="{{ url('teachers') }}">View</a></li>
                                 <li><a href="{{ route('teachers.create') }}">Create</a></li>
                              </ul>
                           </li>
                           <li>
